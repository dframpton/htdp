...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex6.2.3) (read-case-sensitive #t) (teachpacks ((lib "guess.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "guess.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp")))))

;; ex6.2.3.rkt

;; Develop a function draw-bulb. It consumes a symbol that denotes one of the
;; possible colors: 'green, 'yellow, or 'red, and produces true. Its effect is
